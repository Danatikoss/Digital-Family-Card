...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: TjJ0RyVEgYKE/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__eg9A2)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__jm9Gk)}
                role={"img"}
              />
            ),
