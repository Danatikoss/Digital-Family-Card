...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: K424EVBUHEQE/css
import SearchSvg2Icon from "./icons/PlasmicIcon__SearchSvg2"; // plasmic-import: Y14kqAEZ7mjy/icon
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: JsS_eJRQr0w7/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg___0FMnX)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__qzMR)}
              role={"img"}
            />
          ),
