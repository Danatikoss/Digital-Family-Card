...
import sty from "./PlasmicButton.module.css"; // plasmic-import: PIsqyDu_Ruin/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: JsS_eJRQr0w7/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: 0fdYeS-tcKAa/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__mlG1E)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg___6Dafr)}
                role={"img"}
              />
            ),
